...
/**
 * Precompiled com.kensai.poc.scala-common-conventions script plugin.
 **/
public class ComKensaiPocScalaCommonConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        target.getPluginManager().apply("com.adarshr.test-logger");
        target.getPluginManager().apply("cz.alenkacz.gradle.scalafmt");

        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComKensaiPocScalaCommonConventions").asSubclass(BasicScript.class);
