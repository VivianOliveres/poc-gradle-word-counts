...
/**
 * Precompiled com.kensai.poc.scala-scio-conventions script plugin.
 **/
public class ComKensaiPocScalaScioConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        assertSupportedByCurrentGradleVersion();
                target.getPluginManager().apply("com.kensai.poc.scala-scio-conventions");

        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComKensaiPocScalaScioConventions").asSubclass(BasicScript.class);
